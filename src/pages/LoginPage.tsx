...
export default function LoginPage() {
  ...
  return <div className="login-shell">
    ...
    <section className="login-form-panel">
      <div className="login-form"><span className="brand-mark mb-8"><ChartNoAxesCombined size={23} /></span><p className="page-eyebrow">РАДІ БАЧИТИ ВАС ЗНОВУ</p><h2 className="page-title">Увійти до MatchIQ</h2><p className="page-subtitle mb-9">Введіть дані адміністратора, щоб продовжити.</p>
